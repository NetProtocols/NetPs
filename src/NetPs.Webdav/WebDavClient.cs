...
namespace NetPs.Webdav
{
    ...
    public class WebDavClient : IWebDavClient
    {
        ...
        private static HttpClient ConfigureHttpClient(WebDavClientParams @params)
        {
            ...
            //fix: HTTPs证书验证错误
            if (@params.BaseAddress.Scheme.Equals(Uri.UriSchemeHttps))
            {
                httpHandler.ServerCertificateCustomValidationCallback = HttpClientHandler.DangerousAcceptAnyServerCertificateValidator;
                if (@params.ServerCertificateCustomValidationCallback != null)
                {
                    httpHandler.ServerCertificateCustomValidationCallback = @params.ServerCertificateCustomValidationCallback;
                }
            }
